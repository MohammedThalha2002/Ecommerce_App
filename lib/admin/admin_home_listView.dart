...
void deleteProduct(delProductId, context) {
  Products product = Products();
  product.delData(delProductId).then((value) => Navigator.of(context).pop());
  //Show an intimation that U have deleted a product
}

Widget AdminHomeListView({
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: ((context) => AdminUpdateProducts(
                              docId: docId,
                            )),
                      ),
                    );
